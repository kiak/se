...
<h1>Your Purchase was complete.</h1>
<div class="row" >
<div class="span9" >
...
<tr class="odd"><td style="width: 60px"> </td><td> earn</td><td> 21</td><td>  point</td><td class="button-column"> </td></tr>
...
<div class="span3 ">
    ...
    'items'=>array(
        ...
        '---',
       	...
       	'---',
        array('label'=>'Back home', 'url'=>'#', 'active'=>true),
    ),
)); ?>
		</div><!-- sidebar -->
</div><!-- row -->
